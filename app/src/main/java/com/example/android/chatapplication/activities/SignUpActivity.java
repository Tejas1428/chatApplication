...
import com.example.android.chatapplication.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp(){
        ...
        database.collection(Constant.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constant.KEY_USER,documentReference.getId());
    ...
    private Boolean isValidSignUpDetails(){
        if(encodedImage==null) {
            ...
            showToast("Enter the password again");
            return false;
        }else if(!(binding.inputPassword.getText().toString()).equals(binding.inputConfirmPassword.getText().toString())){
            showToast("Password doesnot matches");
            return false;
        }else return true;
    }
